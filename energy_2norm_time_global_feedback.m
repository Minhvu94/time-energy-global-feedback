...
x0 = [2.03887555867469;-0.579682221532998];
...
%     figure(1)
    ...
    step2_current_traj = plot(x_traj(1,:),x_traj(2,:),'k','LineWidth',2);
%     figure(2)
%     hold off
...
%     grid on
    ...
    du_and_dt = quadprog((1+mu)*eye(2*iter_max), 2*[u',T'], [zeros(iter_max),-1*eye(iter_max)], T, H, x_target-x,[],[],[],options);
